...
A library such as the Arduino Stepper library may be used to control the step
and direction output signals.

[[https://www.arduino.cc/reference/en/libraries/stepper/][Arduino Stepper Library]]
